...
class MY_Controller extends CI_Controller {
     ...
     *
     * AUTHOR: Bernadine B. Juliano
     * DESCRIPTION: MY_Controller. Included get, update, insert, _isTokenValid, _sendMail, _insertToken, _sendSMS
   ...
   /*     $this->load->library('email');
     ...
     */
     ...
     public function _sendSMS() {
        $NEXMO_API_KEY =  'cc3cc219';
        $NEXMO_API_SECRET = 'mykgaq8vezmUmEK2';
        $basic  = new \Nexmo\Client\Credentials\Basic($NEXMO_API_KEY, $NEXMO_API_SECRET);
        $client = new \Nexmo\Client($basic);

        $TO_NUMBER = '639061633137';
